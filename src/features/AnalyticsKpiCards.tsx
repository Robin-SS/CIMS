    ...
    <div style={cardContainerStyle}>
      ...
      <div style={cardBaseStyle}>
        <div style={metricSideStyle}>
          <span style={{ fontSize: 22, fontWeight: 800, color: '#D1915F', letterSpacing: -0.5 }}>
            {data.totalIngredientsKg.toLocaleString('en-US', { maximumFractionDigits: 2 })}
          </span>
          <span style={{ fontSize: 10, fontWeight: 800, color: '#8A7E72', marginTop: 2 }}>kg</span>
        </div>
      ...
      <div style={cardBaseStyle}>
        <div style={{ ...metricSideStyle, padding: '4px 12px' }}>
          <span style={{ fontSize: 22, fontWeight: 800, color: '#D1915F', textAlign: 'center', lineHeight: 1.1 }}>
            {data.mostConsumedText.split(' - ')[0]}
          </span>
           <span style={{ fontSize: 10, fontWeight: 800, color: '#8A7E72', marginTop: 4 }}>
      ...
      <div style={cardBaseStyle}>
        <div style={metricSideStyle}>
          <span style={{ fontSize: 25, fontWeight: 800, color: '#D1915F' }}>{data.lowStockItemsCount}</span>
          <span style={{ fontSize: 10, fontWeight: 800, color: '#8A7E72', marginTop: 1, whiteSpace: 'nowrap' }}>reordering</span>
          <span style={{ fontSize: 10, fontWeight: 800, color: '#8A7E72', marginTop: 1, whiteSpace: 'nowrap' }}>required</span>
